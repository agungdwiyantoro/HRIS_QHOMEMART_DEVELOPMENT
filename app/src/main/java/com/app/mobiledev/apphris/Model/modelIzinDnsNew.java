...
public class modelIzinDnsNew {
	private String aproveHrd;
	private String approveHrd;
	private String hrdName;
	private String keperluan;
	private String lsUsr;
	...
	public void setAproveDate(String aproveDate){
	...
	public void setLsUpdt(String lsUpdt){
		this.lsUpdt = lsUpdt;
	}

	public String getLsUpdt(){
		return lsUpdt;
	}
	...
	public void setAproveBy(String aproveBy){
		this.aproveBy = aproveBy;
	}

	public String getAproveBy(){
		return aproveBy;
	}
	...
	public void setAproveHrdDate(String aproveHrdDate){
		this.aproveHrdDate = aproveHrdDate;
	}

	public String getAproveHrdDate(){
		return aproveHrdDate;
	}
