...
public class modelIzinSecVer {
    ...
    String approveDirectur;
    String headKyano;
    String hrdKyano;
    String executivKyano;
    String directurKyano;
    String headApproveDate;
    ...
    public void setIndikasiSakit(String indikasiSakit) {
        this.indikasiSakit = indikasiSakit;
    }

    public String getMulaiSakitTanggal() {
        return mulaiSakitTanggal;
    }

    public void setMulaiSakitTanggal(String mulaiSakitTanggal) {
        this.mulaiSakitTanggal = mulaiSakitTanggal;
    }

    public String getSelesaiSakitTanggal() {
        return selesaiSakitTanggal;
    }

    public void setSelesaiSakitTanggal(String selesaiSakitTanggal) {
        this.selesaiSakitTanggal = selesaiSakitTanggal;
    }
    ...
    public String getLampiranFile() {
        return lampiranFile;
    }

    public void setLampiranFile(String lampiranFile) {
        this.lampiranFile = lampiranFile;
    }
