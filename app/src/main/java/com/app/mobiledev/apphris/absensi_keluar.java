...
public class absensi_keluar extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private LinearLayout lin_abs_keluar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //lin_abs_keluar=findViewById(R.id.lin_abs_keluar);
        sessionmanager = new SessionManager(absensi_keluar.this);
        ...
        detector = new FaceDetector.Builder(absensi_keluar.this)
        ...
        btnAbsen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    if(imageFoto==null){
                        helper.showMsg(absensi_keluar.this,"Informasi","foto belum diiisi");
                        mProgressDialog.dismiss();

                    }else{
                        if(lokasi.equals("null")&&lokasi.equals(null)){
                            helper.showMsg(absensi_keluar.this,"","Lokasi anda belum  terdeteksi \n pastikan gps anda aktif\n coba restart aplikasi",helper.WARNING_TYPE);
                            mProgressDialog.dismiss();
                        }else{

                            new SweetAlertDialog(absensi_keluar.this, SweetAlertDialog.WARNING_TYPE)
                                    ...
                                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                        ...
                                        public void onClick(SweetAlertDialog sweetAlertDialog) {
                                            ...
                                            if(face_count==1){
                                                ...
                                                helper.showMsg(absensi_keluar.this,"Informasi","foto wajah tidak terdeteksi atau terdeteksi lebih dari 1 satu orang");
                                                mProgressDialog.dismiss();
                                            }
    ...
    public void getLokasi(double llat,double llon) {
        try {
            if(llat == 0){
                ...
                Geocoder geocoder = new Geocoder(absensi_keluar.this, Locale.getDefault());
                String result = null;
    ...
    private void absen(final String status,final String kyano){
        AndroidNetworking.post(api.URL_absen)
                ...
                .addBodyParameter("about_alamat", alamat)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (success) {
                                sessionmanager.remove_tgl_presensi_masuk();
                                Log.d("session_tgl_masuk_p", "onClick: "+sessionmanager.getTglPresensiMasuk());
                                new SweetAlertDialog(absensi_keluar.this, SweetAlertDialog.SUCCESS_TYPE)
                                ...
                                helper.showMsg(absensi_keluar.this,"Informasi",""+data,helper.WARNING_TYPE);
                            }
                            ...
                            helper.showMsg(absensi_keluar.this, "Peringatan", ""+helper.PESAN_SERVER, helper.ERROR_TYPE);
                            mProgressDialog.dismiss();
                        }
                    ...
                    public void onError(ANError anError) {
                        ...
                        helper.showMsg(absensi_keluar.this, "Peringatan", ""+helper.PESAN_KONEKSI + anError, helper.ERROR_TYPE);
