...
public class DetailIzinMtApprove extends AppCompatActivity {
    ...
    private String tjano, access, name, kyano, dvnama,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_izin_mt_approve);
        ...
        * */
        ...
        Log.d("CEK_URL_APPROVE", "onCreate: " + api.URL_IzinDinasMT_approve + "id=" + tjano);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (_status.equals("200")) {
                                ...
                                tjano = data.getString("tjano");
                                kyano = data.getString("kyano");
                                select_date = data.getString("tgl");
                                jam = data.getString("jam");
                                sampai = data.getString("sampai");
                                kepentingan = data.getString("kepentingan");
                                ...
                                tx_link_lihat_dokumen.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        if (lampiran.equals("null") || lampiran == null) {
                                            Toast.makeText(DetailIzinMtApprove.this, "Foto izin tidak ada", Toast.LENGTH_SHORT).show();
                                        } else {
                                            dialogFoto();
                                        }
                                    }
    ...
    private void notifDialog(String pesan, String nama, String _value) {
        dialogApprove = new Dialog(DetailIzinMtApprove.this);
        ...
        cvSubmitDialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (_value.equals("0")) {
                    ...
                    updateApprove(tjano, jenis, _value, access,"");
                }
            }
        });
    }
    ...
    private void dialogFoto() {
        dialogFoto = new Dialog(DetailIzinMtApprove.this);
        ...
        Glide.with(DetailIzinMtApprove.this).load(api.URL_foto_izinLampiran + kyano + "/lampiran/surat_mt_dinas/" + lampiran).thumbnail(Glide.with(DetailIzinMtApprove.this).load(R.drawable.loading)).apply(requestOptions).into(img_izin_mt);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (status.equals("200")) {
                                ...
                                helper.messageToast(DetailIzinMtApprove.this, "izin gagal approve..!!");
                            }
