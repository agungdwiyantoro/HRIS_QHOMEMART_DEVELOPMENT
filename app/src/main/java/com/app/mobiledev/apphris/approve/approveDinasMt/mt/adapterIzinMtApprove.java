...
public class adapterIzinMtApprove extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public adapterIzinMtApprove(Context mCtx, List<modelIzinMtNew> modelIzinMtNews, String access, String status) {
        this.mCtx = mCtx;
    ...
    public class ViewHolder extends BaseViewHolder {
        ...
        public void onBind(int position) {
            ...
            tvKetEmp.setText("" + Object.getKepentingan());
            ...
            card_list_riwayat_izin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(mCtx, DetailIzinMtApprove.class);
                    Bundle x = new Bundle();
