...
public class DetailIzinTerlambatApprove extends AppCompatActivity {

    private final String TAG = DetailIzinTerlambatApprove.class.getName();
    private String tjano, access, name, dvnama,
            id_telat, kyano, dvano, jbano, jenis_telat, tgl_telat, jam_sampai,
    ...
    private String
            ...
            executiv_kyano, exec_name, approve_executiv, executiv_approve_date,
            directur_kyano, dir_name, approve_directur, directur_approve_date,
            hrd_kyano, hrd_name, approve_hrd, hrd_approve_date, jenis;
    private TextView
            tv_nama, tv_alasan, tv_tanggal_dan_waktu_pengajuan, tv_jam_kedatangan, tv_lama_waktu_izin, tx_link_lihat_dokumen,
    ...
    private TextView tvJenisTerlambat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_izin_terlambat_approve);
        ...
        tjano = bundle.getString("id_telat");
        access = bundle.getString("access");

        tvTitleDetailApp = findViewById(R.id.tvTitleDetailApp);
        tvTitleDetailApp.setText(R.string.detail_persetujuan_izin_terlambat);
        ...
        tv_jam_kedatangan = findViewById(R.id.tv_jam_kedatangan);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (_status.equals("200")) {
                                ...
                                id_telat = data.getString("id_telat");
                                kyano = data.getString("kyano");
                                dvano = data.getString("dvano");
                                jbano = data.getString("jbano");
                                jenis_telat = data.getString("jenis_telat");
                                jam_sampai = data.getString("jam_sampai");
                                tgl_telat = data.getString("tgl_telat");
                                ...
                                executiv_kyano = data.getString("executiv_kyano");
                                directur_kyano = data.getString("directur_kyano");
                                head_approve_date = data.getString("head_approve_date");
                                hrd_approve_date = data.getString("hrd_approve_date");
                                executiv_approve_date = data.getString("executiv_approve_date");
                                directur_approve_date = data.getString("directur_approve_date");
                                ...
                                switch (status_approve) {
                                    case "TOLAK":
                                        ...
                                        if (approve_head.equals("0")) {
                                            ...
                                            tx_tgl_status.setText(executiv_approve_date);
                                            lin_approve_btn.setVisibility(View.GONE);
                                            card_status_approve.setVisibility(View.VISIBLE);
                                            lin_status_approve.setBackgroundResource(R.color.transparentRed);
                                            ...
                                            tx_tgl_status.setText(directur_approve_date);
                                            lin_approve_btn.setVisibility(View.GONE);
                                            card_status_approve.setVisibility(View.VISIBLE);
                                            lin_status_approve.setBackgroundResource(R.color.transparentRed);
                               ...
                               // tx_keperluan.setText(kepentingan);
                                ...
                                tv_jam_kedatangan.setText(jam_sampai);
                                ...
                                tx_link_lihat_dokumen.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        if (lampiran.equals("null") || lampiran == null) {
                                            Toast.makeText(DetailIzinTerlambatApprove.this, "Foto izin tidak ada", Toast.LENGTH_SHORT).show();
                                        } else {
                                            dialogFoto();
                                        }
                                    }
    ...
    private void notifDialog(String pesan, String nama, String _value) {
        dialogApprove = new Dialog(DetailIzinTerlambatApprove.this);
    ...
    private void dialogFoto() {
        dialogFoto = new Dialog(DetailIzinTerlambatApprove.this);
        ...
        Glide.with(DetailIzinTerlambatApprove.this).load(api.URL_foto_izinLampiran + kyano + "/lampiran/TERLAMBAT/" + lampiran).thumbnail(Glide.with(DetailIzinTerlambatApprove.this).load(R.drawable.loading)).apply(requestOptions).into(img_izin_mt);
    ...
    private void updateApprove(String value, String _id, String hak_akses, String comment) {
        ...
        AndroidNetworking.put(api.URL_IzinOffTerlambat_approve)
                .addHeaders("Authorization", "Bearer " + token)
                .addBodyParameter("kehadiran", "TELAT")
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (status_approve.equals("200")) {
                                ...
                                helper.messageToast(DetailIzinTerlambatApprove.this, "izin gagal approve..!!");
                            }
