...
public class DetailIzinDinasEmp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_izin_dinas_emp);
        ...
        tx_lampiran.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (lampiran_file.equals("null") || lampiran_file == null) {
                    Toast.makeText(DetailIzinDinasEmp.this, "Foto izin tidak ada", Toast.LENGTH_SHORT).show();
                } else {
                    dialogFotoIzinSakit();
                }
            }
    ...
    private void dialogFotoIzinSakit() {
        dialogFoto = new Dialog(DetailIzinDinasEmp.this);
        ...
        Glide.with(DetailIzinDinasEmp.this)
                ...
                .thumbnail(Glide.with(DetailIzinDinasEmp.this)
    ...
    private void checkJabatan() {
        ...
        Volley.newRequestQueue(DetailIzinDinasEmp.this).add(req);
    }

    private void getRiwayatStatusApprove(String jtano) {
        AndroidNetworking.get(api.URL_IzinMt + "?id=" + jtano + "&jenis=DNS")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            tx_catatan.setText(data.getString("ket"));
