...
public class AdapterMemo extends RecyclerView.Adapter<AdapterMemo.HolderMemo> {

    List<ModelMemo> modelMemos;
    Context context;

    public AdapterMemo(List<ModelMemo> modelMemos, Context context) {
    ...
    public HolderMemo onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View row;
        row = inflater.inflate(R.layout.list_memo, viewGroup, false);
