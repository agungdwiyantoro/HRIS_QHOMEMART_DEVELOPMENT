...
public class mulai_istirahat extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private LinearLayout lin_abs_mulai_istirahat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mulai_istirahat);
        image=findViewById(R.id.image);
        tvLokasi=findViewById(R.id.tvLokasi);
        mstatus=findViewById(R.id.status);
        btnAbsen=findViewById(R.id.btnAbsen);
        //lin_abs_mulai_istirahat=findViewById(R.id.lin_abs_mulai_istirahat);
        sessionmanager = new SessionManager(mulai_istirahat.this);
        ...
        detector = new FaceDetector.Builder(mulai_istirahat.this)
        ...
        btnAbsen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    if(imageFoto==null){
                        helper.showMsg(mulai_istirahat.this,"Informasi","foto belum diiisi");
                        ...
                        if(lokasi.equals("null")||lokasi.equals(null)||lokasi.equals("")){
                            ...
                            new SweetAlertDialog(mulai_istirahat.this, SweetAlertDialog.WARNING_TYPE)
                                        ...
                                        public void onClick(SweetAlertDialog sweetAlertDialog) {
                                            ...
                                            if(face_count==1){
                                                if (i == 1) {
                                                    ...
                                                    absen("selesai istirahat",kyano,encodedImage);
                                                ...
                                                helper.showMsg(mulai_istirahat.this,"Informasi","foto wajah tidak terdeteksi atau terdeteksi lebih dari 1 satu orang");
                                                mProgressDialog.dismiss();
                                            }
    ...
    public void getLokasi(double llat,double llon) {
        try {
            if(llat == 0){
                ...
                Geocoder geocoder = new Geocoder(mulai_istirahat.this, Locale.getDefault());
                String result = null;
    ...
    private void absen(final String status,final String kyano,final String encodeimage){
        AndroidNetworking.post(api.URL_absen)
                ...
                .addBodyParameter("abbreakout_alamat",alamat)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (success) {
                                ...
                                new SweetAlertDialog(mulai_istirahat.this, SweetAlertDialog.SUCCESS_TYPE)
                                ...
                                String data = response.getString("ket");
                                helper.showMsg(mulai_istirahat.this,"Informasi",""+data,helper.WARNING_TYPE);
                            }
                            mProgressDialog.dismiss();
                        } catch (JSONException e) {
                            e.printStackTrace();
                            Log.d("JSONERORABSEN", "onResponse: "+e);
                            Log.d("DATA_KIRIM", "onResponse: "+status+" \nkyano"+kyano+" \nlokasi"+lat+","+lon+"\n key"+api.key+"\n base64 "+"data:image/png;base64,"+encodeimage);
                            helper.showMsg(mulai_istirahat.this, "Peringatan", ""+helper.PESAN_SERVER + e.toString(), helper.ERROR_TYPE);
                    ...
                    public void onError(ANError anError) {
                        helper.showMsg(mulai_istirahat.this, "Peringatan", ""+helper.PESAN_KONEKSI + anError, helper.ERROR_TYPE);
