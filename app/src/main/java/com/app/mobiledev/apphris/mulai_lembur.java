...
public class mulai_lembur extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private LinearLayout lin_abs_mulai_lembur;
    int i = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //lin_abs_mulai_lembur=findViewById(R.id.lin_abs_mulai_lembur);
        mstatus=findViewById(R.id.status);
        btnAbsen=findViewById(R.id.btnAbsen);
        sessionmanager = new SessionManager(mulai_lembur.this);
        ...
        detector = new FaceDetector.Builder(mulai_lembur.this)
...
//                }
        ...
        btnAbsen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    if(imageFoto==null){
                        helper.showMsg(mulai_lembur.this,"Informasi","foto belum diiisi");
                        mProgressDialog.dismiss();

                    }else{
                        if(lokasi.equals("null")||lokasi.equals(null)||lokasi.equals("")){
                            helper.showMsg( mulai_lembur.this,"","Lokasi anda belum  terdeteksi \n pastikan gps anda aktif\n coba restart aplikasi",helper.WARNING_TYPE);
                            mProgressDialog.dismiss();
                        }else{

                            new SweetAlertDialog(mulai_lembur.this, SweetAlertDialog.WARNING_TYPE)
                                        ...
                                        public void onClick(SweetAlertDialog sweetAlertDialog) {
                                            ...
                                            if(face_count==1){
                                                if (i == 1) {
                                                    ...
                                                    absen("mulai lembur",kyano,encodedImage);
                                                ...
                                                helper.showMsg(mulai_lembur.this,"Informasi","foto wajah tidak terdeteksi atau terdeteksi lebih dari 1 satu orang");
                                                mProgressDialog.dismiss();
                                            }
    ...
    public void getLokasi(double llat,double llon) {
        try {
            if(llat == 0){
                ...
                Geocoder geocoder = new Geocoder(mulai_lembur.this, Locale.getDefault());
                String result = null;
    ...
    private void absen(final String status, final String kyano, final String encodeimage){
        AndroidNetworking.post(api.URL_absen)
                ...
                .addBodyParameter("ip", helper.getDeviceIMEI(mulai_lembur.this))
                ...
                .addBodyParameter("overin_alamat",alamat)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (success) {
                                ...
                                new SweetAlertDialog(mulai_lembur.this, SweetAlertDialog.SUCCESS_TYPE)
                                ...
                                String data = response.getString("ket");
                                Log.d("KETERANGAN_LEMBUR", "onResponse: "+data);
                                helper.showMsg(mulai_lembur.this,"Informasi",""+helper.PESAN_SERVER,helper.WARNING_TYPE);
                            }
                            mProgressDialog.dismiss();
                        } catch (JSONException e) {
                            e.printStackTrace();
                            Log.d("JSONERORABSEN", "onResponse: "+e);
                            helper.showMsg(mulai_lembur.this, "Peringatan", ""+helper.PESAN_SERVER, helper.ERROR_TYPE);
                            mProgressDialog.dismiss();
                        }
                    ...
                    public void onError(ANError anError) {
                        helper.showMsg(mulai_lembur.this, "Peringatan", ""+helper.PESAN_KONEKSI, helper.ERROR_TYPE);
        ...
        switch (requestCode) {
            case PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(mulai_lembur.this, "Permission denied to read your External storage", Toast.LENGTH_SHORT).show();
                }
            }
        }
        updateLocationUI();
