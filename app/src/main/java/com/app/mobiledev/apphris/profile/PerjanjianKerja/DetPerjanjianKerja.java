...
import com.app.mobiledev.apphris.memo.DetailLampiranMemo;
...
public class DetPerjanjianKerja extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String link = "http://hris.qhomedata.id/upload/karyawan/"+kyano+"/lampiran/kontrak/"+filename;
        new PDFHelper(this, link, new Callable() {
            @Override
            public Void call() {
