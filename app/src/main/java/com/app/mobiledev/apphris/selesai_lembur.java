...
public class selesai_lembur extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionmanager = new SessionManager(selesai_lembur.this);
        ...
        detector = new FaceDetector.Builder(selesai_lembur.this)
        ...
        btnAbsen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if(imageFoto==null){
                        helper.showMsg(selesai_lembur.this,"Informasi","foto belum diiisi");
                        mProgressDialog.dismiss();

                    }else{
                        if(lokasi.equals("null")||lokasi.equals(null)||lokasi.equals("")){
                            helper.showMsg(selesai_lembur.this,"","Lokasi anda belum  terdeteksi \n pastikan gps anda aktif\n coba restart aplikasi",helper.WARNING_TYPE);
                            mProgressDialog.dismiss();
                        }else{
                            new SweetAlertDialog(selesai_lembur.this, SweetAlertDialog.WARNING_TYPE)
                                        ...
                                        public void onClick(SweetAlertDialog sweetAlertDialog) {
                                            ...
                                            if(face_count==1){
                                                if (i == 1) {
                                                    ...
                                                    absen("selesai lembur",kyano,encodedImage);
                                                ...
                                                helper.showMsg(selesai_lembur.this,"Informasi","foto wajah tidak terdeteksi atau terdeteksi lebih dari 1 satu orang");
                                                mProgressDialog.dismiss();
                                            }
    ...
    public void getLokasi(double llat,double llon) {
        try {
            if(llat == 0){
                ...
                Geocoder geocoder = new Geocoder(selesai_lembur.this, Locale.getDefault());
                String result = null;
    ...
    private void absen(final String status,final String kyano,final String encodeimage){
        AndroidNetworking.post(api.URL_absen)
                ...
                .addBodyParameter("overout_alamat", alamat)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (success) {
                                ...
                                helper.showMsg(selesai_lembur.this,"Informasi",""+data,helper.WARNING_TYPE);
                                new SweetAlertDialog(selesai_lembur.this, SweetAlertDialog.SUCCESS_TYPE)
                                ...
                                String data = response.getString("ket");
                                helper.showMsg(selesai_lembur.this,"Informasi",""+helper.PESAN_SERVER,helper.WARNING_TYPE);
                            }
                            mProgressDialog.dismiss();
                        } catch (JSONException e) {
                            e.printStackTrace();
                            Log.d("JSONERORABSEN", "onResponse: "+e);
                            helper.showMsg(selesai_lembur.this, "Peringatan", ""+helper.PESAN_KONEKSI, helper.ERROR_TYPE);
                            mProgressDialog.dismiss();
                        }
                    ...
                    public void onError(ANError anError) {
                        helper.showMsg(selesai_lembur.this, "Peringatan", "ERROR SERVER ABSENSI SELESAI LEMBUR " + anError, helper.ERROR_TYPE);
